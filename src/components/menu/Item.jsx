...
import { EmptyHeart, FullHeart, EmptyStar, FullStar } from "../icons";
...
function Item({
  ...
  return (
    <div className="flex items-center justify-between border border-neutral-400 overflow-hidden rounded-md h-24 lg:h-40 lg:rounded-lg lg:relative">
      <Link to={`/menu/${slug}`}>
      ...
      <div className="p-2 flex-1 lg:px-3 lg:py-0">
        <div className="flex items-center justify-between text-xs sm:mb-2 lg:mb-3">
          <span className="text-neutral-800 font-medium lg:text-lg lg:font-bold lg:mt-1">
        ...
        <div className="flex items-center justify-end xs:justify-between text-xs font-medium text-neutral-800 mb-1 lg:text-base lg:mb-8">
          <span className="hidden xs:block lg:text-sm">
